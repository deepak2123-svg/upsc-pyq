...
export default async function AdminPage() {
  ...
  if (role !== "editor" && role !== "admin") return <main className="public-article"><div className="eyebrow">Editorial workspace</div><h1>Access restricted.</h1><p>Only approved editors and administrators can review or publish questions.</p><p><Link href="/">Return to PYQs →</Link></p></main>;
